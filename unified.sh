...
git clone https://android.googlesource.com/platform/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9 $HOME/TC/arm-linux-gnu-4.9 --depth=1  
...
export CROSS_COMPILE_ARM32="$HOME/TC/arm-linux-gnu-4.9/bin/arm-linux-androideabi-"
